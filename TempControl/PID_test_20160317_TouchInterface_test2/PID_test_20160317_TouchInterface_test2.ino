...
VTEC=4.0*((3.3*Vsense/4096.0)-1.25);
  ...
  draw7Number((int)Output, 60 + 150, 20, 2, ILI9341_WHITE, ILI9341_BLACK, 2);
  draw7Number(abs((int)100 * Output - 100 * (int)Output), 110 + 150, 35, 1, ILI9341_WHITE, ILI9341_BLACK, 2);


  draw7Number((int)fakecurrent, 60 + 150, 20 + 55, 2, ILI9341_WHITE, ILI9341_BLACK, 2);
