...
void loop()
{
  ...
  thermresistance_A2 = 10000.0 * thermvoltage_A[3] / VRref_A2;
...
void drawvalues(int menu_number) {
  if (menu_number == TEC_A_MAIN) {
    ...
    draw7Number(round(100 * Setpoint_A) % 100, 110, 35, 1, ILI9341_WHITE, ILI9341_BLACK, 2);
