...
}else 
{
 ...
 // Serial.println(Input);
  ...
  if (screen == 0)
  {
    ...
    //Right Half
    draw7Number((int)VTEC, 60 + 150, 20, 2, ILI9341_WHITE, ILI9341_BLACK, -2);
    draw7Number(abs((int)100 * VTEC - 100 * (int)VTEC), 110 + 150, 35, 1, ILI9341_WHITE, ILI9341_BLACK, 2);

    draw7Number((int)ITEC, 60 + 150, 20 + 55, 2, ILI9341_WHITE, ILI9341_BLACK, -2);
